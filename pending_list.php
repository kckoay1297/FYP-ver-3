...
<?php
	...
	if ($res->num_rows > 0) {
		...
		if($row['level1'] != -1 and $row['level2'] != -1 and $row['level3'] != -1){
			echo "<a href='view_pending_event.php?id=".$row['pd_index']."'><button type='btn' class='btn btn-primary btn-lg sharp'><i class='material-icons' style='font-size:36px'>view_module	</i><br>".$row['caseName']."</br><br><small>Pending</small></br></button></a>";
		}elseif($row['level3'] == 1){
			echo "<a href='view_pending_event.php?id=".$row['pd_index']."'><button type='btn' class='btn btn-primary btn-lg sharp'><i class='material-icons' style='font-size:36px'>send</i><br>".$row['caseName']."</br><small>Approved</small></button></a>";
		}else{
			//echo "<br></br>";
			echo "<a href='view_pending_event.php?id=".$row['pd_index']."' disabled><button type='btn' class='btn btn-primary btn-lg sharp rejected' disabled><i class='material-icons' style='font-size:36px'>cancel</i><br>".$row['caseName']."</br><small>Cancelled</small></button></a>";
		}
		}
	}else{
		echo "0 result";
