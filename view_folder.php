...
if ($handle = opendir($dir)) {
	...
	for($x = 0;$x < count($files);$x++){
		$name = $dir."/".$files[$x];
		echo "<tr><td><a href=".$dir."/".$files[$x]." target='_blank'>".$files[$x]."</a></td><td><a href='delete_file.php?name=".$name."' target='_blank'>DELETE</a></td></tr>";
	}
}

echo "<a href='add_file.php?dir=".$dir."' class='myBtn btn btn-primary btn-md btn-block' role='button'>Add File</a>";
?>
</tbody>
</table>
</div>
