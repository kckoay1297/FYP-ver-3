...
if ($handle = opendir($directory)) {
	...
	for($x = 0;$x < count($files);$x++){
		...
		echo "<tr><td>".$files[$x]."</td><td><a href=".$directory."/".$files[$x]." target='_blank'>Download</a></td></tr>";
	}
	}else{
		echo "<tr><td>File Not Uploaded Yet</td><td>Not Applicable</td></tr>";
	}
}
?>
</tbody>
